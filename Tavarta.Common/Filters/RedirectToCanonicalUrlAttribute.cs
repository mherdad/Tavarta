...
namespace Tavarta.Common.Filters
{
    ...
    public class RedirectToCanonicalUrlAttribute : FilterAttribute, IAuthorizationFilter
    {
        ...
        public RedirectToCanonicalUrlAttribute(
            ...
            bool lowercaseUrls)
        {
            this._appendTrailingSlash = appendTrailingSlash;
            this._lowercaseUrls = lowercaseUrls;
        } 
        ...
        /// </value>
        public bool AppendTrailingSlash => this._appendTrailingSlash;
        ...
        /// </value>
        public bool LowercaseUrls => this._lowercaseUrls;
        ...
        protected virtual bool TryGetCanonicalUrl(AuthorizationContext filterContext, out string canonicalUrl)
        {
            ...
            if (!this._lowercaseUrls) return isCanonical;
            if (canonicalUrl.Any(character => char.IsUpper(character) && !this.HasNoTrailingSlashAttribute(filterContext)))
            {
