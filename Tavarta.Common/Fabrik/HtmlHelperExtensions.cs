...
namespace Tavarta.Common.Fabrik
{
    public static class HtmlHelperExtensions
    {
        ...
        {
            if (html == null) throw new ArgumentNullException(nameof(html));
            if (trueAction == null) throw new ArgumentNullException(nameof(trueAction));
            if (falseAction == null) throw new ArgumentNullException(nameof(falseAction));
        ...
        {
            if (trueFunc == null) throw new ArgumentNullException(nameof(trueFunc));
            if (falseFunc == null) throw new ArgumentNullException(nameof(falseFunc));
