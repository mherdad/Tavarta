...
using Tavarta.ServiceLayer.CustomAspNetIdentity;
...
namespace Tavarta.ServiceLayer.EFServiecs.Users
{
    public class ApplicationUserManager : UserManager<User, Guid>, IApplicationUserManager
    {
        ...
        public void SeedDatabase()
        {
            ...
            using (var dbcontext = new ApplicationDbContext())
            {
                var user = dbcontext.Users.Select(user1 => new
                {
                    ...
                    user1.DisplayName,
                    user1.UserName,
                    user1.IsSystemAccount,
                    user1.Email,
                    user1.IsApproved
                }).FirstOrDefault(x => x.IsSystemAccount);
            ...
            //var user = Users.Where(x => x.IsSystemAccount ).Select(user1 => new
            //{
            //    user1.Id,
            //    user1.DisplayName,
            //    user1.UserName,
        ...
        //public async virtual Task<string> GetSecurityStampAsync(Guid userId)
        //{
